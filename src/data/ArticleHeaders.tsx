...
export const ArticleData = [
    {
        country: "Croatia",
        city: "Split, Croatia",
        date: "20.05.2023 - 30.05.2023",
        text: "Split is the second-largest city of Croatia after the capital Zagreb, the largest city in Dalmatia and the largest city on the Croatian coast.\n" +
    ...
    },
    {
        ...
        date: "22.12.2023 - 25.12.2023",
        text: "Barcelona is a city on the northeastern coast of Spain. It is the capital and largest city of the autonomous community of Catalonia, \n" + "" +
            "as well as the second-most populous municipality of Spain. With a population of 1.6 million within city limits, \n" + "" +
            "its urban area extends to numerous neighbouring municipalities within the province of Barcelona and is home to around 5.3 million people, \n" +
